...
function CopilotPill({
  ...
  if (!copilot) {
    return (
      <button
        ...
        className={cn(
          base,
          "cursor-pointer gap-1.5 border-border/60 bg-muted/20 text-muted-foreground hover:bg-muted/30 hover:text-foreground",
        )}
      >
  ...
  return (
    <button type="button" onClick={handleClick} className={cn(base, tone)}>
