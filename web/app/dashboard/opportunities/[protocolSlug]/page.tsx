		...
		<div className="px-6 py-8 md:px-7 md:py-9">
			<div className="mx-auto max-w-[1240px]">
						...
						<div>
							...
							<div className="mt-10 space-y-6">
								<MetricLine
									...
									value={formatTokenLike(summary.totalTvlUsd, primary.assetSymbol)}
				...
				<section className="mt-12">
					...
					<div className="mt-6 overflow-x-auto rounded-[22px] border border-border bg-card/80 lg:overflow-x-hidden">
							...
							<div className="divide-y divide-border">
								{opportunities.map((opportunity, index) => (
									...
									>
										...
										<TableValue
											value={formatTokenLike(opportunity.tvlUsd, primary.assetSymbol)}
											secondary={formatCompactUsd(opportunity.tvlUsd)}
										/>
										<TableValue
											value={formatTokenLike(
												opportunity.tvlUsd * remainingCapacityRatio(opportunity),
												primary.assetSymbol,
											)}
										...
										<div className="text-right">
											<InlineBadge tone={liquidityTone(opportunity.liquidityLabel)}>
				...
				<section className="mt-14 border-t border-border pt-10">
					<div className="grid gap-10 lg:grid-cols-[360px_minmax(0,1fr)] lg:items-start">
						<div>
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Withdraw {primary.assetSymbol} through the currently liquid routes.
							</p>
