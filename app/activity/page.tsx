    ...
    <div className="px-6 py-8 md:px-10 md:py-10">
      <div className="flex flex-col gap-1">
        ...
        <p className="max-w-2xl text-sm text-muted-foreground">
          A chronological log of vault actions. Each entry corresponds to a single
          on-chain transaction emitted by the vault contract.
        </p>
      </div>
      ...
      <div className="mt-8 overflow-hidden rounded-xl border hairline bg-card">
        {v.history.length === 0 ? (
          <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
            ...
            <div className="font-display text-base font-semibold">No activity yet</div>
            <p className="mt-1 max-w-sm text-sm text-muted-foreground">
              Once you set a policy, deposit, or approve an allocation, events will
              appear here.
            </p>
          </div>
        ) : (
